...
<body>
	...
	<%
					...
					PreparedStatement pstmt = connect.prepareStatement("INSERT INTO username VALUES (?,?)");
					...
					if(request.getParameter("adduser")!=null){							//check whether the add button is pressed
